...
export const verifyToken = async (idToken: string): Promise<{ id: string }> => {
  const res = await fetch("http://bideo.tech/app/verifyToken", {
    method: "POST",
    headers: {
...
export const loginUser = async (
  ...
  const res = await fetch('http://bideo.tech/app/login', {
    method: "POST",
    body: formData,
  });
...
export const createUser = async (
  ...
  const res = await fetch('http://bideo.tech/app/createUser', {
    method: "POST",
    body: formData,
  });
...
export const getVideoData = async (
  ...
  const res = await fetch(`http://bideo.tech/video/view/${payload.id}`, {
    cache: 'no-store',
  });
...
export const getUser = async (uid: string): Promise<User> => {
  const res = await fetch(`http://bideo.tech/user/getUser/${uid}`, {
    method: "GET",
    headers: {
...
export const updateUser = async (data: User) => {
  ...
  await fetch(`http://bideo.tech/user/update`, {
    method: "POST",
    body: formData,
    headers: myHeaders,
  }).catch((err) => {
...
export const uploadVideo = async (values: UploadVideo) => {
  ...
  await fetch("http://bideo.tech/video/upload", {
    method: "POST",
    body: formData,
    headers: myHeaders,
  }).catch((err) => {
...
export const fetchVideos = async (page: number) => {
  try {
    const res = await fetch(
      `http://bideo.tech/video/all?page=${page}&size=10`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
